...
def trail_score(trailhead, topo_map):
    return len(set([trail[-1] for trail in search_trails(trailhead, topo_map)]))
...
if __name__ == "__main__":
    ...
    print(sum(trail_score(trailhead, topo_map) for trailhead in trailheads))
